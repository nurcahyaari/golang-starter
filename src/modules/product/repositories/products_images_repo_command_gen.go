...
func NewRepoProductsImagesCommand(db *sqlx.DB) RepositoryProductsImagesCommand {
	return &RepositoryProductsImagesCommandImpl{
		db: db,
	}
}

func NewRepoProductsImagesCommandFromTx(tx *sqlx.Tx) RepositoryProductsImagesCommand {
	return &RepositoryProductsImagesCommandImpl{
		tx: tx,
	}
}
